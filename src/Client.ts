...
import { BusinessHoursClient } from "./api/resources/businessHours/client/Client.js";
...
export class FiveOneEatClient {
    ...
    protected _businessHours: BusinessHoursClient | undefined;
    ...
    public get businessHours(): BusinessHoursClient {
        return (this._businessHours ??= new BusinessHoursClient(this._options));
    }
    ...
    public get businessShipping(): BusinessShippingClient {
