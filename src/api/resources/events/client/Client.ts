...
export class EventsClient {
     ...
     *
     * @param {FiveOneEat.GetEventFeedRequest} request
    ...
    ): core.HttpResponsePromise<FiveOneEat.GetEventFeedResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getEventFeed(request, requestOptions));
    }

    private async __getEventFeed(
        request: FiveOneEat.GetEventFeedRequest = {},
        requestOptions?: EventsClient.RequestOptions,
    ): Promise<core.WithRawResponse<FiveOneEat.GetEventFeedResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as FiveOneEat.GetEventFeedResponse, rawResponse: _response.rawResponse };
        }
