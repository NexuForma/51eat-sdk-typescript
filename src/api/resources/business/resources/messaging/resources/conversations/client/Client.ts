...
export class ConversationsClient {
    ...
    /**
     * @param {FiveOneEat.business.messaging.SearchConversationsRequest} request
     * @param {ConversationsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link FiveOneEat.UnauthorizedError}
     * @throws {@link FiveOneEat.UnprocessableEntityError}
    ...
    public search(
        ...
        requestOptions?: ConversationsClient.RequestOptions,
    ): core.HttpResponsePromise<FiveOneEat.business.messaging.SearchConversationsResponse> {
    ...
    private async __search(
        request: FiveOneEat.business.messaging.SearchConversationsRequest,
        requestOptions?: ConversationsClient.RequestOptions,
    ): Promise<core.WithRawResponse<FiveOneEat.business.messaging.SearchConversationsResponse>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.FiveOneEatEnvironment.Production,
                "business/messaging/conversations/search",
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
        ...
        if (_response.ok) {
            return {
                data: _response.body as FiveOneEat.business.messaging.SearchConversationsResponse,
                rawResponse: _response.rawResponse,
            };
        }
