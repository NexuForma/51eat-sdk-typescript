...
export class VariantsClient {
    ...
    private async __create(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `business/products/${core.url.encodePathParam(product)}/variants`,
            ),
            method: "POST",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as FiveOneEat.business.products.CreateVariantsResponse,
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "POST",
            "/business/products/{product}/variants",
        );
    }
    ...
    private async __update(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.FiveOneEatEnvironment.Production,
                `business/products/variants/${core.url.encodePathParam(variant)}`,
            ),
            method: "PUT",
            headers: _headers,
            contentType: "application/json",
        ...
        if (_response.ok) {
            return {
                data: _response.body as FiveOneEat.business.products.UpdateVariantsResponse,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "PUT",
            "/business/products/variants/{variant}",
        );
    }

    /**
     * @param {FiveOneEat.business.products.DeleteVariantsRequest} request
     * @param {VariantsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link FiveOneEat.UnauthorizedError}
     * @throws {@link FiveOneEat.ForbiddenError}
