...
export class TokensClient {
    ...
    ): core.HttpResponsePromise<FiveOneEat.business.auth.ListTokensResponse> {
        return core.HttpResponsePromise.fromPromise(this.__list(requestOptions));
    }

    private async __list(
        requestOptions?: TokensClient.RequestOptions,
    ): Promise<core.WithRawResponse<FiveOneEat.business.auth.ListTokensResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as FiveOneEat.business.auth.ListTokensResponse,
     ...
     *
     * @param {FiveOneEat.business.auth.RevokeTokensRequest} request
     * @param {TokensClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link FiveOneEat.UnauthorizedError}
     *
    ...
    public revoke(
        ...
        requestOptions?: TokensClient.RequestOptions,
    ): core.HttpResponsePromise<FiveOneEat.business.auth.RevokeTokensResponse> {
    ...
    private async __revoke(
        request: FiveOneEat.business.auth.RevokeTokensRequest,
        requestOptions?: TokensClient.RequestOptions,
    ): Promise<core.WithRawResponse<FiveOneEat.business.auth.RevokeTokensResponse>> {
        const { token } = request;
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as FiveOneEat.business.auth.RevokeTokensResponse,
                rawResponse: _response.rawResponse,
            };
        }
