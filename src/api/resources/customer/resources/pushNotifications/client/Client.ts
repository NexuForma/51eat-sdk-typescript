...
export class PushNotificationsClient {
     ...
     *
     * @param {FiveOneEat.customer.StorePushTokenRequest} request
    ...
    ): core.HttpResponsePromise<FiveOneEat.customer.RegisterPushNotificationsResponse> {
    ...
    private async __register(
        request: FiveOneEat.customer.StorePushTokenRequest,
        requestOptions?: PushNotificationsClient.RequestOptions,
    ): Promise<core.WithRawResponse<FiveOneEat.customer.RegisterPushNotificationsResponse>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as FiveOneEat.customer.RegisterPushNotificationsResponse,
     ...
     *
     * @param {FiveOneEat.customer.UnregisterPushNotificationsRequest} request
     * @param {PushNotificationsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link FiveOneEat.UnauthorizedError}
     * @throws {@link FiveOneEat.UnprocessableEntityError}
