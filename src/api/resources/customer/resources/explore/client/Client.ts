...
export declare namespace ExploreClient {
...
export class ExploreClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<ExploreClient.Options>;

    constructor(options: ExploreClient.Options = {}) {
     ...
     *
     * @param {FiveOneEat.customer.BusinessesExploreRequest} request
     * @param {ExploreClient.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<FiveOneEat.customer.BusinessesExploreResponse> {
        return core.HttpResponsePromise.fromPromise(this.__businesses(request, requestOptions));
    }

    private async __businesses(
        request: FiveOneEat.customer.BusinessesExploreRequest,
        requestOptions?: ExploreClient.RequestOptions,
        ...
        if (_response.ok) {
            return {
                data: _response.body as FiveOneEat.customer.BusinessesExploreResponse,
